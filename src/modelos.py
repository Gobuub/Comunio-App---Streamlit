...
class ComunioLib():
    ...
    def create_data_train(journey):
        ...
        cal = pd.read_csv('src/data/train/Season_21-22.csv')
        ...
        points_per_team = points_per_team.rename(columns={
            ...
            'Value': 'Value_Squad',
            'J_4': 'J_4_Squad_Points',
            'J_3': 'J_3_Squad_Points',
            'J_2': 'J_2_Squad_Points',
            'J_1': 'J_1_Squad_Points',
            'J_Actual': 'J_Actual_Squad_Points'})
        ...
        points_per_vs_team = points_per_vs_team.rename(columns={
            ...
            'J_4': 'J_4_Vs_Squad_Points',
            'J_3': 'J_3_Vs_Squad_Points',
            'J_2': 'J_2_Vs_Squad_Points',
            'J_1': 'J_1_Vs_Squad_Points',
            'J_Actual': 'J_Actual_Vs_Squad_Points'})
